    ...
    <div className="space-y-8">
      ...
      <div className={`p-8 md:p-10 ${TOKENS.radius.container} bg-[#E0E5EC] ${TOKENS.shadows.extruded} space-y-10`}>
        ...
        <div className={`p-10 ${TOKENS.radius.container} ${TOKENS.shadows.insetDeep} text-center space-y-4 bg-[#E0E5EC]`}>
          <span className="text-xs font-bold uppercase tracking-widest text-[#6B7280] font-display block">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <button
              ...
              className={`w-full sm:w-auto px-6 py-4 ${TOKENS.radius.button} bg-[#E0E5EC] text-[#38B2AC] font-bold text-sm font-display ${TOKENS.shadows.extrudedSmall} hover:${TOKENS.shadows.extrudedHover} flex items-center justify-center gap-2 ${TOKENS.focus}`}
            >
